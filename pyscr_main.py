...
print(pyscr_custom_task.solve_case(solver, "Курская5", "Пушкинская", ["Курская5", "Пушкинская", "Белорусская2", "Павелецкая5"]))
print(pyscr_test_task.solve_text_case(solver, "Третьяковская", "Охотный ряд"))
print(pyscr_test_task.solve_text_case(solver, "Кропоткинская"))
